...
function __PageMeta() {
  __useEffect(() => {
    ...
    m.setAttribute("content", "Free productivity tools \u2014 digital signature, grammar corrector, file converter and QA effort estimator.");
  }, []);
  return null;
}
({
  ...
  return <>
      ...
      <Section>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {TOOLS.map((t) => <Link key={t.to} to={t.to} className="group rounded-2xl border border-hairline bg-white p-7 shadow-soft hover:-translate-y-1 hover:shadow-glow transition">
