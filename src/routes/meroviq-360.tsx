...
export const Route = createFileRoute("/meroviq-360")({
  head: () => ({
    meta: [
...
const ROADMAP = [
  { q: "Q1", t: "Beta launch · Pipelines & contacts" },
  { q: "Q2", t: "Automation studio & integrations" },
  { q: "Q3", t: "AI assist · Email sequences" },
  { q: "Q4", t: "Mobile apps · Marketplace" },
];
    ...
    <>
      ...
      <Section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {BENEFITS.map((b) => (
            <div key={b.title} className="rounded-2xl border border-hairline bg-white p-7 shadow-soft hover:-translate-y-0.5 transition">
      ...
      <Section className="bg-surface">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {FEATURES.map((f) => (
            <div key={f.title} className="flex gap-5 rounded-2xl border border-hairline bg-white p-7 shadow-soft">
      ...
      <Section>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {ROADMAP.map((r) => (
            <div key={r.q} className="rounded-2xl border border-hairline p-6 bg-white">
      ...
      <Section id="early-access" className="bg-surface">
        <div className="max-w-2xl mx-auto rounded-3xl border border-hairline bg-white p-8 md:p-10 shadow-soft">
          ...
          <form className="mt-6 flex flex-col sm:flex-row gap-3" onSubmit={(e) => { e.preventDefault(); (e.currentTarget as HTMLFormElement).reset(); }}>
