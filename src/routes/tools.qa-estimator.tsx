...
export const Route = createFileRoute("/tools/qa-estimator")({
  head: () => ({
    meta: [
...
function Estimator() {
  ...
  const baseMin = cases * 12; // 12 min/case manual
  ...
  return (
    <div className="grid md:grid-cols-2 gap-6">
      <div className="space-y-5">
        <Range label={`Test cases: ${cases}`} min={10} max={1000} step={10} value={cases} onChange={setCases} />
