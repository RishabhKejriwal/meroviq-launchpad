  ...
  >
      ...
      <Section>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {TRACKS.map((t) => <div key={t.title} className="rounded-2xl border border-hairline p-6 bg-white shadow-soft hover:-translate-y-1 transition">
      ...
      <Section className="bg-surface">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {DURATIONS.map((d, i) => <div key={d.d} className="relative rounded-2xl border border-hairline p-7 bg-white text-center">
      ...
      <Section>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {BENEFITS.map((b) => <div key={b} className="flex items-center gap-3 rounded-xl border border-hairline bg-white p-4">
      ...
      <Section className="bg-surface">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {CAREER.map((c) => <div key={c.t} className="rounded-2xl border border-hairline p-6 bg-white text-center">
